...
* `bgzf_microbench --profile small|medium|large --threads N` measures native
  BGZF read throughput, ordered serial or parallel BGZF write throughput, and
  EOF-check latency using deterministic generated fixtures
